...
def main():
    ...
    with LOG_FILE.open('r') as file:
        for line in file:
            ...
            if parsed is None:  # Invalid line format
                invalid_lines += 1
                continue
            ...
            if level not in ALLOWED_LEVELS:  # Invalid level
                invalid_lines += 1
                continue
    ...
    with CLEAN_FILE.open('w') as clean_file:
    ...
    with SUMMARY_FILE.open('w') as summary_file:
